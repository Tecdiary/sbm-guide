exports.header = {
    ...
    contents: function(pageNum, numPages) {
        return (
            "<p style='font-size: 10px; display: block; font-family: sans-serif; border-bottom: 1px dotted #CCC; padding-bottom: 10px; margin-bottom: 20px;'>SBM Docs <span style='float:right'>" +
            pageNum +
            ' / ' +
            numPages +
            '</span></p>'
